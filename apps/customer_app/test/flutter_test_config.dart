...
///
/// A COPY of the design system's, pointed at that package's font assets: this
/// app renders design-system widgets, so a screen golden taken without those
/// four families is a picture of boxes. `font_guard_test.dart` in this package
/// re-proves the load here rather than trusting that it happened next door.
///
