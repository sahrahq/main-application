...
Map<String, String> _byKey(AppLocalizations l) => <String, String>{
      ...
      'errImageNotFound': l.errImageNotFound,
      'errImageTooLarge': l.errImageTooLarge,
      'errInvalidImage': l.errInvalidImage,
      'errStorageUnavailable': l.errStorageUnavailable,
      'errUnsupportedImageType': l.errUnsupportedImageType,
      ...
      'errOtpSendingUnavailable': l.errOtpSendingUnavailable,
      ...
      'errReservationNotModifiable': l.errReservationNotModifiable,
